...
namespace gen
{
	...
	inline TFloat64 Mod(const TInt64 x, const TFloat32 y) {
		return Mod(static_cast<TFloat64>(x),
			static_cast<TFloat64>(y));
	}
	inline TFloat64 Mod(const TFloat32 x, const TInt64 y) {
		return Mod(static_cast<TFloat64>(x),
			static_cast<TFloat64>(y));
	}
	...
	inline TFloat32 Pow(const TInt32 x, const TInt32 y) {
		return Pow(static_cast<TFloat32>(x),
			static_cast<TFloat32>(y));
	}
	inline TFloat64 Pow(const TInt64 x, const TFloat32 y) {
		return Pow(static_cast<TFloat64>(x),
			static_cast<TFloat64>(y));
	}
	inline TFloat64 Pow(const TFloat32 x, const TInt64 y) {
		return Pow(static_cast<TFloat64>(x),
			static_cast<TFloat64>(y));
	}
	...
	inline TFloat64 Pow(const TInt64 x, const TInt64 y) {
		return Pow(static_cast<TFloat64>(x),
			static_cast<TFloat64>(y));
	}
